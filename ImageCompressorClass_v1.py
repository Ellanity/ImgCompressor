...
class ImageCompressor:
    ...
    def __createNN(self, quantity_of_blocks_for_nn=1024):
        ...
        rand_blocks = [random.choice(list(self.blocks)) for _ in range(0, self.quantity_of_blocks_for_nn)]
        self.nn.trainNeuronNetwork(list(rand_blocks))

    def __compressImageWithNeuralNetwork(self):
        self.compressed_blocks = []
        for block in self.blocks:
            self.compressed_blocks.append(self.nn.runBlockThroughNeuralNetwork(block))
